...
class SCLAlertView : UIView {
    ...
    init () {
        ...
        // Label View
        self.labelView = UILabel(frame: CGRectMake(12, kCircleHeight / 2 + 10, kWindowWidth - 24, 40))
    ...
    func showTitle(view:UIViewController,  title: String, subTitle: String, duration: NSTimeInterval, style: SCLAlertViewStyle) {
