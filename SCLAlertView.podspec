#
#  Be sure to run `pod spec lint SCLAlertView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Viktor"
  # s.authors            = { "Viktor" => "yazexel@gmail.com" }
  ...
  s.source       = { :git => "https://github.com/vikmeup/SCLAlertView-Swift.git", :tag => "0.1.2" }
