...
- (UITextField * __nonnull)addTextFieldWithTitle:(NSString * __nullable)title;
- (SCLButton * __nonnull)addButton:(NSString * __nonnull)title action:(void (^ __nonnull)(void))action;
- (SCLButton * __nonnull)addButton:(NSString * __nonnull)title target:(id __nonnull)target selector:(SEL __null_unspecified)selector;
- (void)hideView;
@end
